...
{  
 model.findByIdAndUpdate(req.body.id, { songname: req.body.songname, singer: req.body.singer,
    movie:req.body.movie,genre:req.body.genre,year:req.body.year},  
   function(err,data) {  
   if (err) {  
   res.send(err);         
   }  
    ...
    model.remove({ _id: req.body.id }, function(err) {    
     if(err){    
         res.send(err);    
            ...
            res.send({data:"Record has been Deleted successully..!!"});               
        }    
 });    
   })  
